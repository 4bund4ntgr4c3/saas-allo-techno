...
export const analyzeMotherboardImageFn = createServerFn({ method: "POST" })
  ...
  .handler(async ({ data: input }): Promise<BoardAnalysisResult> => {
    ...
    return {
      ...
      deviceModel: isApple ? "MacBook Pro 13'' A1706 (Four Thunderbolt 3 Ports)" : "Dell Latitude 5420 / 5520",
      detectedDefects: [
        {
      ...
      criticalPowerRails: [
        {
          ...
          troubleshootingTip: "Si < 10 Ohm : injecter 1.0V sous caméra thermique pour repérer le condensateur chaud.",
        },
        {
          railName: isApple ? "PP3V3_G3H" : "+3V3_ALW",
          nominalVoltage: "3.3 V",
          normalResistanceToGround: "> 40 kOhm",
          troubleshootingTip: "Alimente le contrôleur SMC / EC avant pression du bouton d'allumage.",
        },
        {
          ...
          troubleshootingTip: "Ne pas confondre la basse impédance naturelle du CPU avec un court-circuit !",
        },
      ],
