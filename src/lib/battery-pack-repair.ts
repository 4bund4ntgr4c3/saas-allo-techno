...
export type BatteryPackType =
  "trottinette_36v" | "velo_vae_48v" | "drone_lipo_6s" | "station_solaire_lifepo4";

export type BatteryServiceType =
  "diagnostic_capacite" | "remplacement_bms" | "equilibrage_cellules" | "recellage_integral";
  ...
  switch (serviceType) {
    ...
    case "remplacement_bms":
      return {
        ...
        cellTechnology:
          "Carte de gestion BMS intelligente avec protection thermique et court-circuit",
    ...
    case "recellage_integral":
      return {
        ...
        cellTechnology:
          "Cellules Samsung / LG 18650 / 21700 Grade A d'origine avec soudure par points nickel",
