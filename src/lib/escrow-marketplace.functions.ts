...
export const MOCK_ESCROW_LISTINGS: EscrowListing[] = [
  {
    ...
    specsSummary:
      "Écran FHD IPS 14'', Batterie neuve d'origine, Clavier rétroéclairé, Windows 11 Pro légal",
  ...
  },
  {
    ...
    specsSummary:
      "Gris Sidéral, Batterie 92% de santé (142 cycles), Bloc chargeur Apple 61W d'origine",
  ...
  },
  {
    ...
    specsSummary:
      "Châssis magnésium renforcé, Port RJ45 Gigabit natif, TrackPoint précis, Webcam Cache Privacy",
