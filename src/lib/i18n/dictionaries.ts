...
const fr: Dictionary = {
  ...
  "search.group.recent": "Recherches récentes",
  "devis.leadSent": "Demande envoyée",
  "devis.requestThisEstimate": "Demander ce devis",
  "devis.partOriginal": "Pièce d'origine",
  "devis.mainOE": "Main-d'œuvre",
  "devis.compare.add": "Comparer",
  "devis.compare.max": "Comparaison limitée à 3 devis.",
...
const en: Dictionary = {
  ...
  "devis.leadSent": "Request sent",
  "devis.requestThisEstimate": "Request this quote",
  "devis.partOriginal": "Original part",
  "devis.mainOE": "Labor",
  "devis.compare.add": "Compare",
  "devis.compare.max": "Comparison limited to 3 quotes.",
