  ...
  return (
    <div ref={formTopRef} className="border border-border bg-card p-5 sm:p-7 rounded-2xl max-w-3xl mx-auto space-y-6 shadow-xl animate-in fade-in duration-200">
        ...
        <div className="flex items-center gap-2.5">
          ...
          <div>
            ...
            <p className="text-xs text-muted-foreground">
              Création instantanée des règles de sécurité des données et des postes conforme APDP Bénin
            </p>
          </div>
        </div>
      ...
      <div className="space-y-4 text-xs">
        <div>
          <label className="text-muted-foreground block mb-1">Raison Sociale de l'Organisation :</label>
          <Input
            required
            value={companyName}
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
          ...
          >
            ...
            <span className="text-[10px] text-muted-foreground">Obligatoire sur tous les disques</span>
          </button>
          ...
          >
            ...
            <span className="text-[10px] text-muted-foreground">Analyse antivirus systématique</span>
          </button>
        </div>
      </div>
