    ...
    <div ref={formTopRef} className="border border-border bg-card p-5 sm:p-7 rounded-2xl max-w-3xl mx-auto space-y-6 shadow-xl animate-in fade-in duration-200">
        ...
        <div className="flex items-center gap-2.5">
          ...
          <div>
            ...
            <p className="text-xs text-muted-foreground">
              Détection des versions pirates/expirées et devis de régularisation en licences officielles
            </p>
          </div>
        </div>
      ...
      <form onSubmit={handleRunAudit} className="space-y-4 text-xs">
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          ...
          <div>
            <label className="text-muted-foreground block mb-1">Nombre d'ordinateurs du parc :</label>
            <Input
              type="number"
              min={1}
              max={1000}
        ...
        <div className="space-y-5 pt-2 border-t border-border animate-in fade-in duration-200 text-xs">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
            <div className="p-3.5 rounded-xl border border-destructive/40 bg-destructive/5 space-y-1">
              <span className="text-[10px] text-destructive font-bold block">Score de Conformité</span>
            ...
            <div className="p-3.5 rounded-xl border border-border bg-surface/60 space-y-1">
              <span className="text-[10px] text-muted-foreground block">Budget Régularisation OEM</span>
            ...
            <div className="p-3.5 rounded-xl border border-border bg-surface/60 space-y-1">
              <span className="text-[10px] text-muted-foreground block">Risque d'Amende Évitée</span>
                ...
                >
                  <div className="space-y-0.5">
                    ...
                    <div className="flex items-center gap-2 text-[11px]">
                      <span className="text-emerald-600 font-medium">{item.legitimateLicensedCount} conformes</span>
                      <span className="text-destructive font-bold">· {item.unlicensedPiratedCount} non conformes</span>
                    </div>
                  </div>
