...
const PAGES: Omit<Item, "icon">[] = [
  ...
  {
    id: "page-diagnostic-auto",
    label: "Banc de Diagnostic Matériel",
    hint: "Test clavier, pixels écran, micro et webcam en direct",
    keywords: "diagnostic test clavier ecran micro webcam panne banc automatique",
    target: { to: "/diagnostic-auto" },
  },
  {
    id: "page-parrainage",
    label: "Programme de Parrainage & Affiliation",
    hint: "Gagnez des commissions en Mobile Money MTN / Moov",
    keywords: "parrainage parrain filleul affiliation commission argent momo mobile money",
    target: { to: "/parrainage" },
  },
  {
  ...
  {
    id: "page-abonnements",
    label: "Abonnements & Packs Sérénité",
    hint: "Entretien illimité et PC de courtoisie",
    keywords: "abonnement pack serenite formule annuel mensuel contrat entretien",
    target: { to: "/abonnements" },
  },
  {
    id: "page-test-technique",
    label: "Test Technique de Recrutement",
    hint: "QCM d'évaluation en micro-soudure & électronique",
    keywords: "recrutement test technique micro-soudure qcm examen emploi stage",
    target: { to: "/work-at/test-technique" },
  },
  {
    id: "page-changelog",
    label: "Journal des Mises à Jour (Changelog)",
    hint: "Historique des 50 versions et nouvelles fonctionnalités",
    keywords: "changelog nouveautes mises a jour versions patch notes",
    target: { to: "/changelog" },
  },
  {
    id: "page-panier",
