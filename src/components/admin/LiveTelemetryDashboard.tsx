...
import { Activity, AlertTriangle, CheckCircle2, ShieldAlert, Cpu, HardDrive, Battery, RefreshCw } from "lucide-react";
import { Button } from "@/components/ui/button";
import { Badge } from "@/components/ui/badge";
import {
  getLiveTelemetryFleetFn,
  type TelemetryEndpoint,
} from "@/lib/telemetry-agent.functions";
        ...
        <div className="flex items-center gap-2.5">
          ...
          <div>
            ...
            <p className="text-xs text-muted-foreground">
              Surveillance proactive de la température CPU, santé SSD et prédiction de pannes de flotte
            </p>
          </div>
        </div>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 pt-2.5 text-xs">
              <div className="flex items-center gap-2">
                ...
                <div>
                  ...
                  <strong className={`font-mono text-xs ${ep.cpuTempCelsius > 80 ? "text-destructive font-bold" : "text-foreground"}`}>
              ...
              <div className="flex items-center gap-2">
                ...
                <div>
                  ...
                  <strong className={`font-mono text-xs ${ep.ssdHealthPercent < 30 ? "text-destructive font-bold" : "text-foreground"}`}>
              ...
              <div className="flex items-center gap-2">
                ...
                <div>
                  ...
                  <strong className="font-mono text-xs text-foreground">{ep.batteryHealthPercent}%</strong>
                </div>
              </div>
              ...
              <div className="flex items-center justify-end">
                {ep.riskStatus === "critique" ? (
                  ...
                  <Badge variant="outline" className="text-amber-600 border-amber-600/40 bg-amber-600/10 text-[10px] font-bold">
                    Entretien Conseillé
                  </Badge>
                ) : (
              ...
              <div className="mt-3 p-3 rounded-lg bg-background border border-destructive/30 space-y-1 text-xs">
                <div className="flex items-center justify-between text-destructive font-bold text-[11px]">
                  <span className="flex items-center gap-1.5">
                    <ShieldAlert className="size-3.5" /> Panne Matérielle Prévue sous {ep.predictedFailure.estimatedDaysRemaining} jours :
                  </span>
