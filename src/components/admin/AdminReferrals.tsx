    ...
    <div className="space-y-4">
      ...
      <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <div className="rounded-lg border bg-card p-4">
          <div className="flex items-center gap-2 mb-1">
            ...
            <span className="text-[10px] uppercase text-muted-foreground">Complétés</span>
          </div>
        ...
        <div className="rounded-lg border bg-card p-4">
          <div className="flex items-center gap-2 mb-1">
            ...
            <span className="text-[10px] uppercase text-muted-foreground">Gagné</span>
          </div>
        ...
        <div className="rounded-lg border bg-card p-4">
          <div className="flex items-center gap-2 mb-1">
            ...
            <span className="text-[10px] uppercase text-muted-foreground">Niveau</span>
          </div>
      ...
      {entries.length > 0 && (
        <div className="space-y-2">
          <h4 className="text-sm font-bold">Historique des parrainages</h4>
          {entries.map((e) => (
            <div key={e.id} className="flex items-center justify-between rounded-lg border bg-card p-3">
              <div>
                <p className="text-xs font-medium">
                  Parrainage — {new Date(e.created_at).toLocaleDateString("fr-BJ")}
                </p>
                <p className="text-[10px] text-muted-foreground">Statut: {e.status}</p>
              </div>
