...
export const COVERAGE_ZONES: CoverageZone[] = [
  // ── Abomey-Calavi (Zone Atelier & Proximité Immédiate) ──
  {
    ...
    quartier: "Zogbadjè / UAC",
    estimatedArrivalMinutes: 15,
    expressAvailable: true,
    baseDeliveryFeeFcfa: 1000,
  },
  {
    id: "calavi-centre",
    commune: "Abomey-Calavi",
    quartier: "Calavi Centre / Kpota",
  ...
  },
  {
    id: "calavi-tankpe",
    commune: "Abomey-Calavi",
    quartier: "Tankpè / Parana",
    estimatedArrivalMinutes: 20,
    expressAvailable: true,
    baseDeliveryFeeFcfa: 1000,
  },
  {
    id: "calavi-arconville",
    commune: "Abomey-Calavi",
    quartier: "Arconville / Zoundja",
    estimatedArrivalMinutes: 25,
    expressAvailable: true,
    baseDeliveryFeeFcfa: 1500,
  },
  {
    id: "calavi-godomey",
    commune: "Abomey-Calavi",
  ...
  {
    id: "cotonou-haie-vive",
    commune: "Cotonou",
    quartier: "Haie Vive / Les Cocotiers",
    estimatedArrivalMinutes: 30,
    expressAvailable: true,
    baseDeliveryFeeFcfa: 2000,
  },
  {
    id: "cotonou-ganhi",
    commune: "Cotonou",
    quartier: "Ganhi / Marina / Zone Commerciale",
    estimatedArrivalMinutes: 35,
    expressAvailable: true,
    baseDeliveryFeeFcfa: 2000,
  },
  {
    id: "cotonou-cadjehoun",
    commune: "Cotonou",
  ...
  {
    id: "cotonou-saint-michel",
    commune: "Cotonou",
    quartier: "Saint-Michel / Gbégamey",
    estimatedArrivalMinutes: 30,
    expressAvailable: true,
    baseDeliveryFeeFcfa: 2000,
  },
  ...
  },
  {
    id: "cotonou-vedoko",
    commune: "Cotonou",
    quartier: "Vèdoko / Kouhounou (Stade)",
    estimatedArrivalMinutes: 25,
    expressAvailable: true,
    baseDeliveryFeeFcfa: 1500,
  },
  {
    id: "cotonou-akpakpa",
    commune: "Cotonou",
    quartier: "Akpakpa / PK3 / Avotrou",
    estimatedArrivalMinutes: 45,
    expressAvailable: true,
    baseDeliveryFeeFcfa: 2500,
  },
  {
    id: "cotonou-agla",
    commune: "Cotonou",
    quartier: "Agla / Fidjrossè / Plage",
    estimatedArrivalMinutes: 30,
    expressAvailable: true,
    baseDeliveryFeeFcfa: 2000,
  },
  ...
  // ── Ouidah & Porto-Novo ──
  {
    id: "porto-novo-centre",
    commune: "Porto-Novo",
    quartier: "Porto-Novo Centre / Ouando",
    estimatedArrivalMinutes: 60,
    expressAvailable: false,
    baseDeliveryFeeFcfa: 3500,
  },
  {
    id: "ouidah-centre",
    commune: "Ouidah",
    quartier: "Ouidah Centre / Kpassè",
    estimatedArrivalMinutes: 60,
    expressAvailable: false,
    baseDeliveryFeeFcfa: 3500,
  },
