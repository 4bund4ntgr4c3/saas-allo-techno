...
export const BRANDS: Brand[] = [
  ...
  },
  {
    ...
    name: "Huawei",
    tag: "Pura · Mate · Nova",
    devices: ["Pura", "Mate", "Nova"],
    icon: brandIcon("huawei"),
  },
  {
    slug: "oppo",
    name: "Oppo",
    tag: "Reno 13 · A Series",
    devices: ["Reno", "A Series", "Find"],
    icon: brandIcon("oppo"),
  },
  {
    slug: "google",
    ...
    tag: "Pixel 6 à 10",
    devices: ["Pixel"],
    icon: brandIcon("google"),
  },
  {
    slug: "oneplus",
    name: "OnePlus",
    tag: "Nord · Série 13",
    devices: ["Nord", "Série 13"],
    icon: brandIcon("oneplus"),
  },
  {
    slug: "tecno",
    name: "Tecno",
  ...
  },
  {
    ...
    name: "Nokia",
    tag: "G · X · C Series",
    devices: ["G Series", "C Series"],
    icon: brandIcon("nokia"),
  },
  {
    slug: "motorola",
    name: "Motorola",
    tag: "Moto G · Edge 50",
    devices: ["Moto G", "Edge"],
    icon: brandIcon("motorola"),
  },
  {
    slug: "honor",
    name: "Honor",
    tag: "Magic 7 · X Series",
    devices: ["Magic", "X Series"],
    icon: brandIcon("honor"),
  },
  {
    slug: "sony",
    name: "Sony",
  ...
  },
  {
    slug: "dell",
    name: "Dell",
    tag: "XPS · Latitude · Inspiron",
    devices: ["XPS", "Latitude"],
    icon: brandIcon("dell"),
  },
  {
    slug: "realme",
